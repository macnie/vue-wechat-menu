    ...
    <div class="public-account-management clearfix">
        ...
        <div class="left">
            <div class="menu clearfix">
                <div class="menu_bottom" v-for="(item, i) of menu.button" :key="i">
                    <!-- 一级菜单 -->
                    <div @click="menuFun(i,item)" class="menu_item" :class="{'active': isActive == i}">{{item.name}}
                    </div>
                    <!--以下为二级菜单-->
                    <div class="submenu" v-if="isSubMenuFlag == i">
                        ...
                        <div class="menu_bottom menu_addicon" v-if="item.sub_button.length < 5"
        ...
        <el-card v-if="!showRightFlag" class="right">
            <div slot="header" class="clearfix">
                <span>设置菜单</span>
                <el-button size="mini" style="float: right" type="danger" icon="el-icon-delete" @click="deleteMenu(tempObj)">删除当前菜单
                </el-button>
            </div>
            ...
            <el-form label-width="180px">
                ...
                <el-form-item v-if="false">
                    <div class="material" v-if="tempObj.type == 'media_id'">
                        <span>素材内容：</span>
                        <el-input class="input_width" v-model="tempObj.media_id" placeholder="素材名称"
                    ...
                    <el-form-item label="小程序appid" v-if="tempObj.type == 'miniprogram'">
                        <el-input class="input_width" v-model="tempObj.appid" placeholder="请输入小程序的appid" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="小程序的页面路径" v-if="tempObj.type == 'miniprogram'">
            ...
            <el-alert
                    ...
                    title="提示"
                    type="alert"
                    description="设置成功后，微信有缓存时间，需要稍等会才生效。或者重新关注公众号立刻生效。"
                    show-icon>
            </el-alert>
        ...
        <el-card v-if="showRightFlag" class="right">
            <p style="text-align:center;">请选择菜单配置</p>
        </el-card>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //模拟调取菜单数据
            mockMediaFun() {
                this.$http.get('/api/wechat/media')
                    .then((res) => {
